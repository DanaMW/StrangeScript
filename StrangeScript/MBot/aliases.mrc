...
load.rest {
  ...
  load -rs script2.mrc
  load -rs unmask.mrc
  load -rs spell.mrcssssaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
...
/join.setup {
  ...
  .raw mode $me +i
  set %IRCX.mode OFF
  if ($server == strange.selfip.biz) { ircx | set %IRCX.mode ON | .msg nickserv identify %irc.nick.pass }
