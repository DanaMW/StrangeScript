...
n44=..Edit: keyedit $network saved.nick.1 "Saved nick 1"
...
n49=..Edit: keyedit $network saved.nick.2 "Saved nick 2"
n50=..Clear: keywrite $network saved.nick.2Nick Password
n51=Nick Passwords
n52=.$key($network,saved.nick.1) $chr(91) $key($network,$key($network,saved.nick.1)) $chr(93) $+ :
n53=..Identify: { NickServ Identify $key($network,$me) }
n54=..Edit: keyedit $network $key($network,saved.nick.1) "New Nick Password"
n55=..Clear:{ keywrite $network $key($network,saved.nick.1) | $report(StrangeScript,$key($network,saved.nick.1),password,$null,Cleared).active }
n56=.$key($network,saved.nick.2) $chr(91) $key($network,$key($network,saved.nick.2)) $chr(93) $+ :
n57=..Identify: { NickServ Identify $key($network,saved.nick.2) }
n58=..Edit: keyedit $network $key($network,saved.nick.2) "New Nick Password"
n59=..Clear:{ keywrite $network $key($network,saved.nick.2) | $report(StrangeScript,$key($network,saved.nick.2),password,$null,Cleared).active }
n60=Auto Nick Recover $chr(91) $key($network,recover.nick) $chr(93) $+ :
n61=.On:{ keywrite $network recover.nick ON | $report(StrangeScript,Auto Nick Recover,$null,$null,Toggled to,$key($network,recover.nick)).active }
n62=.Off:{ keywrite $network recover.nick OFF | $report(StrangeScript,Auto Nick Recover,$null,$null,Toggled to,$key($network,recover.nick)).active }
n63=Do Nick Recover
n64=.Recover Nick $chr(91) $key($network,saved.nick.1) $chr(93) $+ :/recover $key($network,saved.nick.1)
n65=.Recover Nick $chr(91) $key($network,saved.nick.2) $chr(93) $+ :/recover $key($network,saved.nick.2)
n66=-
n67=MemoServ Menu
n68=.Send Menu
n69=..Send User:{ memoserv send $$?="Nick To Send To?" $$?="Message Your Sending" }
n70=..Send Chan: memoserv send # $$?="Message To Send To This Channel"
n71=..Send Sop:halt
n72=.Read Menu:
n73=..List All Memos:/memoserv list
n74=..List A Memo:/memoserv list $$?="NUM Of Memo To List?"
n75=..Read A Memo:/memoserv read $$?="NUM Of Memo To Read?"
n76=..Delete A Memo:/memoserv del $$?="NUM Of Memo To Delete?"
n77=..UnDelete A Memo:/memoserv undelete $$?="NUM Of Memo To UnDelete?"
n78=..Purge Deleted:/MemoServ purge
n79=